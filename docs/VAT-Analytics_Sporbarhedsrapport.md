...
> Auto-genereret af `tools/build_traceability.py` · katalogversion **1.5.0** · 2026-09-20

## Dækning

- Kontroller i alt: **109** (aktive: **105**, inaktive: **4**)
- Præcis kilde udfyldt: **0 / 109** (resten viser kategoriens retsområde indtil den fagansvarlige pinner paragraffen)
- Dækkende valideringstest udfyldt: **105 / 109** (valideringssuiten dækker alle 105 aktive kontroller; de 4 uden test er de inaktive)

## Analyse-moduler (momsrelevans-slankning)

| Modul | Default | Kontroller | Beskrivelse |
|-------|---------|------------|-------------|
| Momskerne | TIL | 66 | Kontroller med direkte momsfaglig konsekvens: sats, fradragsret, angivelse, reverse charge, place-of-supply og momsafstemning. Fundamentet i en momsgennemgang. |
...
| VATA-109 | Fradragsprocent-afvigelse | aktiv | Momskerne | TIL | Krydsdimensionelle kontroller: valuta/kode, EU-/3.-landskøb uden RC-beregning, import, bilagstype (momsloven, Skattestyrelsens kontrolmetoder) | tests/test_validation_suite.py + validation/scenarios.py |
