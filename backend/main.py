...
"""
VAT Analytics API
Momsanalyse fra Excel/CSV data — 109 automatiserede tests.
...
app = FastAPI(
    ...
    description="Momsanalyse fra Excel/CSV data — 109 automatiserede tests baseret på Skattestyrelsens kontrolmetoder",
    version="0.2.0",
)
# Maks upload: 2 GB
...
async def analyze(request: Request, file: UploadFile = File(...),
                  user=Depends(central_auth.require_tool), _=Depends(auth.verify_csrf)):
    """
    Upload en Excel/CSV fil og kør alle 109 momsanalyser.
